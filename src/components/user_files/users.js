    ...
    return (
        <>
            <main style={{margin:'50px',}}> 
                <div style={{paddingBottom:'10px',paddingTop:'10px',width:'270px', paddingInline:'5px', background:'#e2e8f0', borderRadius:'10px'}}>
                    <div style={{display:'flex', justifyContent:'flex-end', verticalAlign:'middle',marginRight:'5px'}}>
                        <p style={{display:'block', padding:'1px 3px', marginRight:'5px', borderRadius:'5px', background:'#f8fafc', fontWeight:'bold', fontSize:'10px'}}>Gas | 30%</p>
